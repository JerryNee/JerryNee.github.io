...
export const ThisComputer: React.FC<WindowAppProps> = (props) => (
    ...
    >
        ...
        <p>
            A restored retro desktop for portfolio browsing, project notes,
            resume access, and a few carefully sourced classic game entries.
        </p>
...
const styles: Record<string, React.CSSProperties> = {
    ...
    title: {
        fontFamily: 'MillenniumBold, MSSerif, serif',
        fontSize: 28,
        lineHeight: 1.1,
    },
    lead: {
